...
export async function analyzeToken(address: string): Promise<AnalysisResult> {
  ...
  if (!pair) {
    ...
    return {
      ...
      chart: { score: 0, trend: "flat", rsi: null, rsiDivergence: null, recentBullishPatterns: [], recentBearishPatterns: [], chartPatterns: [], breakout: null, volumeConfirmation: false, notes: ["no chart data"] },
      intermarket,
